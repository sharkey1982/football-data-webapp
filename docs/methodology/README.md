...
7. **`lineup_confidence` label mismatch.** The mapping expects `'consensus_v3'`, but the views emit `'lineup_consensus_v3'`, so consensus-based rows show 0.55 instead of 0.90. See [expected-minutes.md](expected-minutes.md), caveat 1.
